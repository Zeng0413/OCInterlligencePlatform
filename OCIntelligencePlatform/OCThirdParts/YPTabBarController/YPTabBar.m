...
//#define TITLE_SELECTED_COLOR []

#define itemSelectedBackColor CLEAR
#define itemNormalBackColor WHITE
...
- (void)awakeFromNib {
    ...
    _itemTitleColor = RGBA(153, 153, 153, 1);
    ...
    _badgeTitleFont = [UIFont systemFontOfSize:12];
...
- (void)setFrame:(CGRect)frame {
    ...
    self.layer.shadowOffset = CGSizeMake(0, 0); //(0,0)时是四周都有阴影
    self.layer.shadowRadius = 4;
    self.layer.shadowColor = TEXT_COLOR_LIGHT_GRAY.CGColor;
...
- (void)setItems:(NSArray *)items {
    ...
    for (YPTabItem *item in self.items) {
        ...
        [item setContentHorizontalCenterWithVerticalOffset:0 spacing:0];
...
- (void)setSelectedItemIndex:(NSInteger)selectedItemIndex {
    ...
    if (_selectedItemIndex >= 0) {
		...
		oldSelectedItem.backgroundColor = itemNormalBackColor;
	...
	//選擇item背景色
	newSelectedItem.backgroundColor = itemSelectedBackColor;
