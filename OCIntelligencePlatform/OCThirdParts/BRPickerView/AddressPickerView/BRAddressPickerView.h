...
typedef void(^BRAcademyResultBlock)(BRAcademyModel *academy, BRSubjectModel *subject, BRProfessionModel *profession);
typedef void(^BRAcademyCancelBlock)(void);

typedef void(^BRClassroomResultBlock)(xqModel *xq, jxlModel *jxl, jsModel *js);
typedef void(^BRClassroomCancelBlock)(void);
...
// 学员选择器
+ (void)showAcademyPickerWithShowType:(BRAddressPickerMode)showType
                           dataSource:(NSArray *)dataSource
                      defaultSelected:(NSArray *)defaultSelectedArr
                         isAutoSelect:(BOOL)isAutoSelect
                           themeColor:(UIColor *)themeColor
...
// 教学楼选择器
+ (void)showClassroomPickerWithShowType:(BRAddressPickerMode)showType
                           dataSource:(NSArray *)dataSource
                      defaultSelected:(NSArray *)defaultSelectedArr
                         isAutoSelect:(BOOL)isAutoSelect
                           themeColor:(UIColor *)themeColor
