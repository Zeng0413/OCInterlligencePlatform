...
public class LTLayout: NSObject {
    ...
    /*  */
    @objc public var isTableViewBouncesEnabled: Bool = false
    ...
    /* 滑块底部线的高 */
    @objc public var bottomLineHeight: CGFloat = 4.0
    ...
    /* pageView底部线的高度 */
    @objc public var pageBottomLineHeight: CGFloat = 0.0
    ...
    /* 是否允许切换页面 */
    @objc public var enableChange: Bool = true
...
public class LTPageView: UIView {
    ...
    @objc public var glt_buttons: [UIButton] = []
    ...
    @objc public var didCurrerntIndexBlock:PageViewDidSelectIndexBlock?
...
//        pageTitleView.backgroundColor = UIColor(red: 241/255.0, green: 245/255.0, blue: 249/255.0, alpha: 1)
    ...
    private lazy var sliderLineView: UIView = {
        ...
        sliderLineView.layer.cornerRadius = self.layout.bottomLineHeight/2;
...
//        sliderScrollView.backgroundColor = UIColor(red: 241/255.0, green: 245/255.0, blue: 249/255.0, alpha: 1)
...
extension LTPageView {
    ...
    @objc private func titleSelectIndex(_ btn: UIButton)  {
        if !layout.enableChange {
            return
        }
        didCurrerntIndexBlock?(self, btn.tag)
            ...
            if isClick {
                ...
                if layout.isNeedScale {
                    UIView.animate(withDuration: 0.2, animations: {
                        ...
                        upButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
                    })
                }
...
extension LTPageView: UIScrollViewDelegate {
    ...
    public func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        scrollView.isScrollEnabled = layout.enableChange;
        if !layout.enableChange {
            return;
        }
