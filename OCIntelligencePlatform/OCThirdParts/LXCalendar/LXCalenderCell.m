...
- (void)awakeFromNib {
    [super awakeFromNib];
    self.label.font = kFont(14*FITWIDTH);
    // Initialization code
...
//            [self.label setFTCornerdious:self.label.lx_width/2];
            ...
            self.label.textColor = TEXT_COLOR_BLACK;
        }
//        self.label.textColor = model.currentMonthTitleColor?model.currentMonthTitleColor:TEXT_COLOR_BLACK;
//        if (model.isToday) {
