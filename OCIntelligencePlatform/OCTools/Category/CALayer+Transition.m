...
- (void)transitionAnimation:(CGFloat)duration type:(CATransitionType)type subtype:(CATransitionSubtype)subtype timingFunction:(CAMediaTimingFunctionName)timingFunction {
    CATransition * transition = [CATransition animation];
    transition.duration = duration;
